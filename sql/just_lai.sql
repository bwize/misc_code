with frac (bg_id, pop_frac, hh_frac, hu_frac) as (
    ...
    where ST_Contains(ST_GeomFromText('{coordinates}', 3857) , b.geom)
...
--sum(hu_frac * houseunit__total__total_vacant_housing_units__count__1) as house__total__total_vacant_housing_units__count,
...
----
--COALESCE(avg((hu_frac * houseunit__total__vacant_for_sale_only__count) / (NULLIF(((hu_frac * houseunit__total__vacant_for_sale_only__count) + (hu_frac * houseunit__owner_vs_renter__owner_occupied__count__1)),0))) * 100) as houseunit__total__homeowner_vacancy_rate__percent__1,
--COALESCE(avg((hu_frac * houseunit__total__vacant_for_rent__count) / (NULLIF(((hu_frac * houseunit__total__vacant_for_rent__count) + (hu_frac * houseunit__owner_vs_renter__renter_occupied__count__2)),0))) * 100) AS houseunit__total__rental_vacancy_rate__percent__1,
--COALESCE(avg((pop_frac * pop__total__college_graduate__count) / NULLIF(pop_frac * pop__total__over_25__count, 0)) * 100) as pop__total__college_graduation_rate__percent__1,
--COALESCE(avg((pop_frac * pop__total__high_school_graduate__count) / NULLIF(pop_frac * pop__total__over_25__count, 0)) * 100) as pop__total__high_school_graduation_rate__percent__2,
--COALESCE(avg((pop_frac * pop__total__language_other_than_english__count) / NULLIF(pop_frac * pop__total__over_5__count, 0)) * 100) as pop__total__primary_lang_other_than_english__percent,
----
...
--sum(pop_frac * pop__total__over_65__count) as pop__total__over_65__count,
...
--
--sum(hh_frac * house__grapi__less_than_15__percent) as house__grapi__less_than_15__percent,
--sum(hh_frac * house__grapi__15_to_20__percent) as house__grapi__15_to_20__percent,
--sum(hh_frac * house__grapi__20_to_25__percent) as house__grapi__20_to_25__percent,
--sum(hh_frac * house__grapi__25_to_30__percent) as house__grapi__25_to_30__percent,
--sum(hh_frac * house__grapi__30_to_35__percent) as house__grapi__30_to_35__percent,
--sum(hh_frac * house__grapi__35_or_more__percent) as house__grapi__35_or_more__percent,
--sum(hh_frac * house__smocapi__less_than_15__percent) as house__smocapi__less_than_15__percent,
--sum(hh_frac * house__smocapi__15_to_20__percent) as house__smocapi__15_to_20__percent,
--sum(hh_frac * house__smocapi__20_to_25__percent) as house__smocapi__20_to_25__percent,
--sum(hh_frac * house__smocapi__25_to_30__percent) as house__smocapi__25_to_30__percent,
--sum(hh_frac * house__smocapi__30_to_35__percent) as house__smocapi__30_to_35__percent,
--sum(hh_frac * house__smocapi__35_or_more__percent) as house__smocapi__35_or_more__percent,
--
--
...
avg(hh_frac * house__total__pct_renters__percent) as house__total__pct_renters__percent,
...
sum(hh_frac * house__total__commuters_per_hh_owners__count) as house__total__commuters_per_hh_owners__count,
sum(hh_frac * house__total__commuters_per_hh_renters__count) as house__total__commuters_per_hh_renters__count,
...
from frac
inner join dashboard_blockgroup_mview as v
    on v.bg_id = frac.bg_id
;
